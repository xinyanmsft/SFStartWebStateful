...
{
    [EventSource(Name = "MyCompany-Application1.FabricApplication-WebService")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        public void ServiceMessage(ServiceContext serviceContext, string message, params object[] args)
        {
            if (this.IsEnabled())
            {
                ...
                ServiceMessage(
                    ...
                    ((StatefulServiceContext)serviceContext).ReplicaId,
        ...
        {
            HealthInformation info = new HealthInformation("WebService", property, healthState);
        ...
        public void ServiceRequestStop(string requestTypeName, double duration)
        {
            WriteEvent(ServiceRequestStopEventId, requestTypeName, duration);
        }
